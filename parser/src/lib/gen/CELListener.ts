...
import { CreateMapContext } from "./CELParser";
...
export default class CELListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `CreateMap`
	 * labeled alternative in `CELParser.primary`.
	 * @param ctx the parse tree
	 */
	enterCreateMap?: (ctx: CreateMapContext) => void;
	/**
	 * Exit a parse tree produced by the `CreateMap`
	 * labeled alternative in `CELParser.primary`.
	 * @param ctx the parse tree
	 */
	exitCreateMap?: (ctx: CreateMapContext) => void;
	/**
